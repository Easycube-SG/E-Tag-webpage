...
const tiers = [
  {
    ...
    name: 'drop & collect',
    badge: 'Hero offer',
    bestFor: 'Home-based businesses and small retailers.',
    price: 'S$1.20',
    period: 'per parcel',
    features: [
      'No min parcel requirement',
      'Drop at your local collection point',
      'Tracking and Auto shopper notification',
      'E-proof of delivery',
    ],
    highlighted: true,
  },
  {
    ...
    bestFor: 'SME with higher volume of parcels',
    price: 'S$2.20',
    period: 'per parcel',
    features: [
